package io.github.vvb2060.magisk.core.download
...
import io.github.vvb2060.magisk.core.JobService
import io.github.vvb2060.magisk.core.R
import io.github.vvb2060.magisk.core.base.IActivityExtension
import io.github.vvb2060.magisk.core.cmp
import io.github.vvb2060.magisk.core.di.ServiceLocator
import io.github.vvb2060.magisk.core.intent
import io.github.vvb2060.magisk.core.ktx.set
import io.github.vvb2060.magisk.core.utils.ProgressInputStream
...
class DownloadEngine(session: DownloadSession) : DownloadSession by session, DownloadNotifier {
    ...
    companion object {
        const val ACTION = "io.github.vvb2060.magisk.DOWNLOAD"
        ...
        private fun createBroadcastIntent(context: Context, subject: Subject) =
            context.intent<io.github.vvb2060.magisk.core.Receiver>()
                .setAction(ACTION)
                .putExtra(SUBJECT_KEY, subject)

        private fun createServiceIntent(context: Context, subject: Subject) =
            context.intent<io.github.vvb2060.magisk.core.Service>()
                .setAction(ACTION)
                .putExtra(SUBJECT_KEY, subject)
